    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="bg-gradient-to-r from-green-700 to-green-500 text-white py-20 px-6 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
          {user ? (
            <>
              Welcome <span className="text-green-300">{user.username}</span> to RideNITT
            </>
          ) : (
            <>
              Welcome to Ride<span className="text-green-300">NITT</span>
            </>
          )}
        </h1>
        ...
        <Link
          to="/about"
          className="inline-block bg-white text-green-700 px-6 py-3 rounded-full font-semibold hover:bg-green-100 transition"
        >
          Learn More
        </Link>
      </section>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12">
          Why Use Ride<span className="text-green-700">NITT</span>?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-green-50 p-6 rounded-lg shadow hover:shadow-md transition">
            ...
            <p>
              Only verified NITT users can use the platform, ensuring safety and trust within the
              community.
            </p>
          </div>
        </div>
      ...
      <section className="bg-green-100 py-14 text-center px-6">
        ...
        <p className="text-lg mb-6">
          Connect with fellow students and make your trips easier and greener.
        </p>
        <Link
          to="https://ridenitt.in"
